...
if(checkUserSession($db) !== FALSE){
	...
	if(strlen($room_name) >= 5){
		if(strlen($room_desc) >= 5){
			...
			$createStatus = array("success" => false, "message" => "Room description must be 5 characters or above.");
		}
	} else {
		$createStatus = array("success" => false, "message" => "Room name must be 5 characters or above.");
	}
