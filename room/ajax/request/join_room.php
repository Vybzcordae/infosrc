...
if(checkUserSession($db) !== FALSE && !empty($_POST["room_id"])){
	...
	if(mysqli_num_rows($query) == 0){
		...
		mysqli_query($db, "INSERT INTO request_join(id, user_id, room_id, join_date) VALUES (NULL, $user_id, $room_id, '$dateTime')") or die(json_encode(array("success" => false, "message" => "Error sql query")));
