                    ...
                    <div class="ibox float-e-margins">
						...
						?>
							...
							if(mysqli_num_rows($query) < 1){
								echo "You haven't created any room!";
							}
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
						...
						?>
								<div class="social-feed-box" id="room-<?= $room["room_id"] ?>">
								<div class="social-avatar">
									<small class="text-muted"><?= $room["room_name"] ?> (You joined <?= format_time_ago(strtotime($mem["join_date"])) ?>)</small>
								</div>
								<div class="social-body">
									<strong>Description: </strong> <?= !empty($room["room_description"]) ? $room["room_description"] : "null"; ?>
								<p></p><hr><p></p>
							...
							<?php endwhile;
							if(mysqli_num_rows($query) < 1){
								echo "You haven't joined any room!";
							}
