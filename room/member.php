                    ...
                    <div class="ibox float-e-margins">
						...
						?>
								...
								<div class="social-avatar">
									<small class="text-muted">Joined room on <?= $req["join_date"] ?></small>
								</div>
								...
								<div class="file-option">
									...
									<button class="btn btn-danger btn-rounded btn-sm" onclick="delete_member(<?= $req["user_id"] ?>,<?= $req["room_id"] ?>)"><i class="fa fa-times"></i> Delete member</button>
								</div>
										</div>
								</div>
							<?php 
	...
	$.ajax({
		...
		success: function(r) {
			if(r.success){
				...
				toastr.error("Error, member not deleted")
			}
		},
		error: function(){
