                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="register_form" method="POST" action="" class="form-horizontal">
								...
								<div class="form-group"><label class="col-sm-1 control-label">E-Mail</label>
									<div class="col-sm-10"><input type="email" name="email" value="" class="form-control" autocomplete="off"></div>
								</div>
								<div class="form-group"><label class="col-sm-1 control-label">Profile Image</label>
									<div class="col-sm-10"><input type="file" name="image" value="" class="form-control"></div>
								</div>
