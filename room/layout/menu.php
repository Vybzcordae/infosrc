        ...
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
				...
				<?php if($inLogin): ?>
                    ...
                    ?>
                    <span><img alt="image" class="img-circle" src="../Admin/php/images/<?= $profilePicture ?>" width="60px" height="60px" /></span><?php endif; ?>
			...
			<?php endif; ?>
 			<li>
                <a href="<?= $_LOGOUT_FILE ?>"><i class="fa fa-sign-out"></i> <span class="nav-label">Logout</span></a>
            </li>
			<?php endif; ?>
        </ul>
    </div>
