            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry" data-portfolio-sort="original-order">
                    ...
                    <ul class="portfolio-flters" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <li class="filter-active">Books</li>
                        <li><a href="Tools2.php">Applications</a></li>
                        

                    </ul>
                    <ul class="portfolio-flters" data-aos="fade-up">
                    <form action="search_tools1.php" method="post" class="mt-3">
                    ...
                    <div class="row gy-4 portfolio-container1" data-aos="fade-up" data-aos-delay="300">

                    <?php
                        include_once "Admin/config/db.php";
                        $query = mysqli_query($conn, "SELECT * FROM uploads WHERE type='Book'");
