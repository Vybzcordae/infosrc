...
if(!empty($tool_search)){
	...
	$query = mysqli_query($conn, "select * from uploads where name='{$tool_search}' AND type='Application'"); //$_HOME_FILE --> /config/value.php
	if(mysqli_num_rows($query) > 0){
		//$_SESSION["current_room_id"] = $room_id;
		$tools_data = mysqli_fetch_array($query);
					
	} else {
		echo "<script>alert('No Item with this name !!'); window.location='Tools2.php'</script>";
	}
}else {
	echo "<script>alert('Please enter Item name !!'); window.location='Tools2.php'</script>";
}
?>
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <a href="index.php" class="logo d-flex align-items-center">
                ...
                <h1 class="d-flex align-items-center">InfoSrc</h1>
            </a>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry" data-portfolio-sort="original-order">
                    ...
                    <ul class="portfolio-flters" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <li><a href="Tools2.php">Books</a></li>
                        <li>Applications</li>
