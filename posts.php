                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <?php
                            ...
                            $query = mysqli_query($con, "SELECT * FROM posts ORDER BY user_id DESC LIMIT 4");
                                ...
                                <article class="d-flex flex-column">
                                    ...
                                    <div class="meta-top">
                                        <ul>
                                            ...
                                            <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="post-details.php?user_id=<?= !empty($ro["user_id"]) ? $ro["user_id"] : "null"; ?>"><?= !empty($ro["views"]) ? $ro["views"] : "0"; ?> Answers</a></li>
                                        </ul>
                                    </div>
                                </article>
                            </div>
                        ...
                        <div class="row view">
                            <div class="text-center">
                                <a href="postsAll.php"><button type="submit" class="submit">View all</button></a>
                            </div>
                        </div>
                        <?php endif;
                        ?>
